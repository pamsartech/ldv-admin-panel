...
function ViewPayment() {
  ...
  // ✅ Destructure and set safe fallback
  const {
    customerName,
    email,
    phoneNumber,
    ...
    createdAt,
    notes,
    stripeTransaction = {}, // safe fallback
  } = paymentData || {};
    ...
    <div>
      ...
      <div className="flex justify-between mt-5 mx-10">
        ...
        <div>
          ...
          <button
            onClick={() =>
              navigate(`/update-payment/${paymentData._id}`, {
                state: { paymentData },
              })
            }
