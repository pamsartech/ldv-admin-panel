        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              ...
              <img className="w-20 h-15 " src="/LaDolceVita.png" alt="" />
            </div>

            {/* Center - Nav Links (Desktop) */}
            <div className="hidden md:flex flex-1 justify-center space-x-8">
              {["About Us", "Purchase Page", "Live Schedule", "Reviews"].map(
                (item) => (
                  <a
                    key={item}
            ...
            <div className="hidden md:flex">
              <button
                onClick={() => navigate("/choose-item/step-1")}
        ...
        >
          <ul className="flex flex-col space-y-4 px-4 py-4">
            ...
            <li>
              <button
                onClick={() => navigate("/choose-item/step-1")}
                className="w-full bg-[#B21E1E] hover:bg-[#CC3333] text-white px-4 py-2 rounded-full transition-colors duration-300"
              >
                Buy Your Products Now
              </button>
            </li>
